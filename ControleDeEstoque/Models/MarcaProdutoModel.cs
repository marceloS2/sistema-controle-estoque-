        ...
        public static int RecuperarQuantidade()
        {
            ...
            using (var conexao = new SqlConnection())
            {
                ...
                using (var comando = new SqlCommand())
                {
                    ...
                    comando.CommandText = "SELECT COUNT (*) FROM marca_produto"; // query de conexão
        ...
        public static MarcaProdutoModel RecuperarPeloId(int id)
        {
            ...
            using (var conexao = new SqlConnection())
            {
                ...
                using (var comando = new SqlCommand())
                {
                    ...
                    comando.Connection = conexao;
                    comando.CommandText = "SELECT  * FROM marca_produto WHERE (id = @id)";// query de conexão
            ...
            if (RecuperarPeloId(id) != null)
            {
                using (var conexao = new SqlConnection())
                {
                    ...
                    using (var comando = new SqlCommand())
                    {
                        ...
                        comando.Connection = conexao;
                        comando.CommandText = "DELETE FROM marca_produto WHERE (id = @id)";// query de conexão
                        comando.Parameters.Add("@id", SqlDbType.Int).Value = id;
